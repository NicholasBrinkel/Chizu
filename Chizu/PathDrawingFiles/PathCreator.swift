...
class PathCreator: NSObject {
    ...
    let defaultPathStyle = PathStyleProvider(strokeEnd: 0, lineWidth: 3, strokeColor: UIColor(red: 200/255, green: 73/255, blue: 56/255, alpha: 1).cgColor, fillColor: nil, opacity: 1)
